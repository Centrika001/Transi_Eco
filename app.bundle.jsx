...
function TopNav() {
  ...
  return (
    <div className="topnav">
      <div className="brand">
        <img className="logo" src=asset("logoJpg") alt="Transi Remesas" style={{ height: 26 }} />
  ...
  return (
    <section id="intro" className="hero" data-screen-label="00 Intro">
      <div className="hero-top">
        <div>
          <img src=asset("logoJpg") alt="Transi" style={{ display: 'block', height: 72, width: 'auto', marginBottom: 20, borderRadius: 8 }} />
  ...
  return (
    <section id="ecosistema" className="section" data-screen-label="01 Ecosistema" style={{ background: '#FFFFFF' }}>
      <div className="container" style={{ display: 'grid', gridTemplateColumns: 'minmax(280px, 380px) 1fr', gap: 48, alignItems: 'center', height: '100%' }}>
        <div>
          <img src=asset("logoJpg") alt="Transi" style={{ display: 'block', height: 'auto', marginBottom: 24, width: "250px" }} />
    ...
    <ChannelSection
      ...
      <div style={{ background: 'var(--paper-2)', borderRadius: 10, padding: '28px', display: 'flex', flexDirection: 'column', gap: 14, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ background: '#0E1116', borderRadius: 8, padding: '20px 22px', color: '#FAFAF7', display: 'grid', gridTemplateColumns: '1fr auto', gap: 16, alignItems: 'center', position: 'relative' }}>
            ...
            <img src=asset("logoJpg") alt="" style={{ width: 48, height: 48, borderRadius: 6, background: '#FAFAF7', padding: 4, objectFit: 'contain' }} />
          </div>
          {/* Status strip */}
  ...
  return (
    <section id="whatsapp" className="section" data-screen-label="07 WhatsApp AI" style={{ background: '#0E1116', color: 'var(--paper)' }}>
      <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 360px', gap: 40, alignItems: 'center', height: '100%' }}>
        <div>
          <img src=asset("whatsappPng") alt="WhatsApp" style={{ display: 'block', width: 56, height: 56, marginBottom: 20 }} />
